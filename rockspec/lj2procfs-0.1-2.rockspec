 ...
 version = "0.1-2"
 source = {
    url = "https://github.com/wiladams/lj2procfs/archive/v0.1-2.tar.gz",
    dir = "lj2procfs-0.1-2",
 }
 description = {
 ...
 supported_platforms = {"linux"}
  ...
  build = {
    ...
    modules = {
      ...
      ["lj2procfs.codecs.environ"] = "lj2procfs/codecs/process/environ.lua",
      ["lj2procfs.codecs.exe"] = "lj2procfs/codecs/process/exe.lua",
      ["lj2procfs.codecs.io"] = "lj2procfs/codecs/process/io.lua",
      ["lj2procfs.codecs.limits"] = "lj2procfs/codecs/process/limits.lua",
      ["lj2procfs.codecs.maps"] = "lj2procfs/codecs/process/maps.lua",
      ["lj2procfs.codecs.mounts"] = "lj2procfs/codecs/process/mounts.lua",
      ["lj2procfs.codecs.sched"] = "lj2procfs/codecs/process/sched.lua",
      ["lj2procfs.codecs.status"] = "lj2procfs/codecs/process/status.lua",

      -- codecs for flat files in /proc/net
      ["lj2procfs.codecs.dev"] = "lj2procfs/codecs/net/dev.lua",
      ["lj2procfs.codecs.netstat"] = "lj2procfs/codecs/net/netstat.lua",
